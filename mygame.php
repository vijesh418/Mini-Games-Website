...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
            <ul class="navbar-nav  ms-auto">
                ...
                <li class="navbar-item2">
                    <div class="item2"><a class="nav-link" href="mailto:isddhanthsuvarnaplatinum@gmail.com">Contact</a></div>
                </li>
    ...
    <section class="sectiongame">
        <div class="zone">
            <p class="subtitle">LIKED GAMES</p>
        </div>
...
if (isset($_SESSION['user_name']))
{
            ...
            $select = " SELECT * FROM game WHERE id = '$id' and gameid=1 and liked=1";
...
if (isset($_SESSION['user_name']))
{
            ...
            $select = " SELECT * FROM game WHERE id = '$id' and gameid=2 and liked=1";
...
if (isset($_SESSION['user_name']))
{
            ...
            $select = " SELECT * FROM game WHERE id = '$id' and gameid=3 and liked=1";
 ...
 ?>
                ...
                <div class="col-lg-4 col-sm-12 col-md-4 cards">
                    ...
                    <div class="card-content">
                        ...
                        <p class="">
                            <span class="span">Strike with all might!</span>
                        </p>
                    </div>
                </div>
...
if (isset($_SESSION['user_name']))
{
            ...
            $select = " SELECT * FROM game WHERE id = '$id' and gameid=4 and liked=1";
...
if (isset($_SESSION['user_name']))
{
            ...
            $select = " SELECT * FROM game WHERE id = '$id' and gameid=5 and liked=1";
...
if (isset($_SESSION['user_name']))
{
            ...
            $select = " SELECT * FROM game WHERE id = '$id' and gameid=6 and liked=1";
