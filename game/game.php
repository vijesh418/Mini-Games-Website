...
<div style="color:#ffb300; height: auto; width:25%; position:absolute; left: 72%; top: 175px;"><h3>Description</h3>Punchers is a 3D boxing game with ragdoll physics. Use move keys to dodge from enemy punches and hit back with random punch combinations. You can play against another player or AI.<br><br>Controls:<br>&#x2022;Left player use the WASD keys and Y, U<br>&#x2022; Right player use arrow keys and numpad 1, 2</div>
