...
?>
    ...
    <div class="bg">
        <iframe src="https://www.crazygames.com/embed/foosball-3d" class="game" style="width: 70%; height: 80%;"
...
<div style="color:#fff000; height:50%; width:25%; position:absolute; left: 72%; top: 175px;"><h3>Description</h3>Foosball 3D is a table soccer game that you can play by yourself or with your friend. Score as many goals as possible before the time runs out and be the winner of the Foosball 3D soccer game.<br><br>Controls:<br>&#x2022;WASD or arrow keys = controls the foosball men<br>&#x2022;Space = start the game</div>
    </div>
</body>
