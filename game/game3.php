...
?>
    ...
    <div class="bg">
        <iframe src="https://www.crazygames.com/embed/striker-dummies" class="game" style="width: 70%; height: 80%;"
...
<div style="color:#fff000; height:50%; width:25%; position:absolute; left: 72%; top: 175px;"><h3>Description</h3>Striker Dummies is a fun and exciting fighting game in which you control a wooden dummy. The aim is simple – you must try and destroy the other wooden dummy by hitting them with your giant hammer! The winner of this intense dual is the first one to reach 5 points.<br>Time your smashes carefully and try to avoid their crushing blows too. You can either play against a friend in a dual control setup, or you can simply fight against an AI opponent. Can you be crowned the striker dummy champion?<br><br>Features:<br>&#x2022; Wooden dummies fighting game<br>&#x2022; Single and two player modes<br>&#x2022;Easy controls</div>
    </div>
</body>
