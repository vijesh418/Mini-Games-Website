...
?>
    ...
    <div class="bg">
        <iframe src="https://www.crazygames.com/embed/infiltrating-the-airship" class="game" style="width: 70%; height: 80%;"
...
<div style="color:#ffb300; height: auto; width:25%; position:absolute; left: 72%; top: 175px;"><h3>Description</h3>Can you choose wisely and help the stickman in this game to accomplish his goals? Ralph the stickman is attempting to infiltrate a gigantic airship to capture the villainous Henry. You must use your intelligence to help him choose the correct course of action to ensure he succeeds.<br><br>Features:<br>&#x2022; Choice-based gameplay<br>&#x2022; Packed with humor and with<br>&#x2022; A variety of different endings and possible outcomes</div>
